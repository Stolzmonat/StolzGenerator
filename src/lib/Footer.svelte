<script lang="ts">
  import appIcon from "../assets/icon_alt_2.png";
...
<footer>
  ...
  <div>
    {@html $_("header")}
    <br />{@html $_("by")} <a href="https://x.com/HaeFZett" target="_blank">HFZ</a>
    <br />2023 - 2333
  </div>
  <div id="footer-icons">
    <a
    ...
    >
      <img
        alt="GitHub icon"
        src="https://hihiqy1.nl/index_assets/icons/mark-github.svg"
      />
    </a>
  </div>
</footer>
